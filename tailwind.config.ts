      ...
      typography: {
        warm: {
          css: {
            ...
            // 목록 줄간격 축소
            'ul > li': { marginTop: '0.2em', marginBottom: '0.2em' },
            'ol > li': { marginTop: '0.2em', marginBottom: '0.2em' },
            'li > ul': { marginTop: '0.2em', marginBottom: '0.2em' },
            'li > ol': { marginTop: '0.2em', marginBottom: '0.2em' },
          },
        },
      },
    },
